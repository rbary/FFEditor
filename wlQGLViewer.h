...
public:
  wlQGLViewer(QWidget *parent=0, QSize size=QSize(SIZE,SIZE), const QGLWidget *shareWidget=0, Qt::WFlags flags=0);
  wlQGLViewer(QGLContext *context, QWidget *parent=0, QSize size=QSize(SIZE,SIZE), const QGLWidget *shareWidget=0, Qt::WFlags flags=0);
  wlQGLViewer(const QGLFormat &format, QWidget *parent=0, QSize size=QSize(SIZE,SIZE), const QGLWidget *shareWidget=0, Qt::WFlags flags=0);
  virtual ~wlQGLViewer() {};
